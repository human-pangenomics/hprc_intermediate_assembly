...
[data_sample_level_summary_release2_v1.0.csv](https://github.com/human-pangenomics/hprc_intermediate_assembly/blob/main/data_tables/sequencing_data/data_sample_level_summary_release2_v1.0.csv) provides a per-sample aggregated coverage summary across all sequencing technologies. Each row represents one R2 sample (232 total, excluding CHM13 and GRCh38 references) with the following coverage columns:

| Column | Description |
|---|---|
| `coverage_hifi` | Total HiFi coverage (including DeepConsensus-only samples) |
| `coverage_hic` | Total Hi-C coverage |
| `coverage_ill` | Total Illumina coverage |
| `coverage_100kb_ont` | ONT coverage from reads ≥100kb |
| `total_reads_kinnex` | Total Kinnex (Iso-Seq) read count |
| `meth_wg_cov` | HiFi coverage from the methylation working group harmonized dataset |
| `n50_hifi` | Weighted average HiFi read N50 |
| `read_N50_ont` | Weighted average ONT read N50 |

This file is generated by `collapse.py` from the individual technology index files.

## How to download
Assembly sequencing data can be downloaded using the path column in the data_SequencingTechnology_release2_v1.0.index.csv file (e.g., data_ont_release2_v1.0.index.csv).
...
[data_ont_release2_v1.0.index.csv](https://github.com/human-pangenomics/hprc_intermediate_assembly/blob/main/data_tables/sequencing_data/data_ont_release2_v1.0.index.csv)
...
### HiC
[data_hic_release2_v1.0.index.csv](https://github.com/human-pangenomics/hprc_intermediate_assembly/blob/main/data_tables/sequencing_data/data_hic_release2_v1.0.index.csv)

### Illumina 1K Genomes
[data_illumina_release2_v1.0.index.csv](https://github.com/human-pangenomics/hprc_intermediate_assembly/blob/main/data_tables/sequencing_data/data_illumina_release2_v1.0.index.csv)
...
[data_kinnex_release2_v1.0.index.csv](https://github.com/human-pangenomics/hprc_intermediate_assembly/blob/main/data_tables/sequencing_data/data_kinnex_release2_v1.0.index.csv)
Kinnex data is provided as flnc.bams.  See [PacBio IsoSeq documentation](https://isoseq.how/) for details. 


#### User Notes
* 206 R2 samples have Kinnex data available.
...
```
* v1.0 (2026 Jun 25): Release 2 final index files. Rename pre_release to release2_v1.0. Add methylation working group index.
