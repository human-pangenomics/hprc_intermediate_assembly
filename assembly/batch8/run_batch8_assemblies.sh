...
# cp HPRC_Assembly_s3Locs_batch8_w_*.csv \
#      /private/groups/hprc/hprc_intermediate_assembly/assembly/batch8/

# cp hifiasm_input_jsons/* \
#      /private/groups/hprc/hprc_intermediate_assembly/assembly/batch8/hifiasm_input_jsons/
