...
#SBATCH --job-name=HPRC-groupbyxy-batch4
...
#SBATCH --mem=200gb
#SBATCH --output=groupbyxy_submit_logs/groupbyxy_submit_%x_%j_%A_%a.log
#SBATCH --time=1-0:00
