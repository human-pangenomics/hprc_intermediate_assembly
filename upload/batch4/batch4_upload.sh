...
cp /private/groups/hprc/polishing/batch5/hprc_polishing_QC_k31/HPRC_Intermediate_Assembly_s3Locs_Batch4_w_hifiasm_w_QC.polished.csv ./

## no need to filter out any samples (which feels weird)
grep -vE '^NA18612|^NA20752' \
    HPRC_Intermediate_Assembly_s3Locs_Batch4_w_hifiasm_w_QC.polished.csv \
    > hprc_int_asm_batch4_polished.csv
...
python3 /private/groups/hprc/hprc_intermediate_assembly/hpc/launch_from_table.py \
     --data_table ../hprc_int_asm_batch4_polished.csv \
...
sbatch \
     ...
     --sample_csv hprc_int_asm_batch4_polished.csv \
     --input_json_path '../input_jsons/${SAMPLE_ID}_assembly_cleanup.json' 

## collect results into data table    
python3 /private/groups/hprc/hprc_intermediate_assembly/hpc/update_table_with_outputs.py \
    --input_data_table hprc_int_asm_batch4_polished.csv \
    --output_data_table batch4_genbank_upload_prep_outputs.csv  \
...
python3 /private/groups/hprc/hprc_intermediate_assembly/hpc/misc/extract_asm_cleanup_stats.py \
    --input_csv ../batch4_genbank_upload_prep_outputs.csv \
    --output_prefix hprc_int_asm_batch4
...
python3 /private/groups/hprc/hprc_intermediate_assembly/hpc/misc/link_to_folder.py \
    --data_table_csv batch4_genbank_upload_prep_outputs.csv \
    --columns_to_link hap1_output_fasta_gz hap2_output_fasta_gz \
    --target_dir batch4_genbank_upload
...
ascp \
    ...
    -l100m \
    -k1 \
    -d batch4_genbank_upload \
    subasp@upload.ncbi.nlm.nih.gov:uploads/juklucas_ucsc.edu_tD3gRQfz/int_asm_batch4
...
python3 /private/groups/hprc/hprc_intermediate_assembly/hpc/misc/link_to_subfolder.py \
     --csv_file ../batch4_genbank_upload_prep_outputs.csv \
...
ssds staging upload \
    ...
    upload \
    &>>batch4_s3_upload_pt1.upload.stderr
