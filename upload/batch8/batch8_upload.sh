...
cp /private/groups/hprc/polishing/batch9/hprc_polishing_QC_k31/HPRC_Assembly_s3Locs_batch8_w_hifiasm.polished.csv ./

## filter out failures (or samples who need attention)
grep -vE '^HG00867' \
    HPRC_Assembly_s3Locs_batch8_w_hifiasm.polished.csv  \
    > hprc_int_asm_batch8_polished.csv
...
python3 /private/groups/hprc/hprc_intermediate_assembly/hpc/launch_from_table.py \
     --data_table ../hprc_int_asm_batch8_polished.csv \
...
#      --sample_csv hprc_int_asm_batch8_polished.csv \
...
#     --input_data_table hprc_int_asm_batch8_polished.csv \
#     --output_data_table batch8_genbank_upload_prep_outputs.csv  \
...
#     --input_csv ../batch8_genbank_upload_prep_outputs.csv \
#     --output_prefix hprc_int_asm_batch8
...
#     --data_table_csv batch8_genbank_upload_prep_outputs.csv \
#     --columns_to_link hap1_output_fasta_gz hap2_output_fasta_gz \
#     --target_dir batch8_genbank_upload
...
#     -l100m \
#     -k1 \
#     -d batch8_genbank_upload \
#     subasp@upload.ncbi.nlm.nih.gov:uploads/juklucas_ucsc.edu_tD3gRQfz/int_asm_batch8
...
#      --csv_file ../batch8_genbank_upload_prep_outputs.csv \
...
#     upload \
#     &>>batch8_s3_upload_pt1.upload.stderr
