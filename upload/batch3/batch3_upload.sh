...
cp /private/groups/hprc/hprc_intermediate_assembly/polishing/batch4/apply_GQ_filter/hprc_polishing_QC_k31/HPRC_Intermediate_Assembly_s3Locs_Batch3_w_hifiasm_w_qc.polished.filterVcf.polished.csv ./

## no need to filter out any samples (which feels weird)
cat \
    HPRC_Intermediate_Assembly_s3Locs_Batch3_w_hifiasm_w_qc.polished.filterVcf.polished.csv \
    > hprc_int_asm_batch3_polished.csv
...
python3 /private/groups/hprc/hprc_intermediate_assembly/hpc/launch_from_table.py \
     --data_table ../hprc_int_asm_batch3_polished.csv \
...
sbatch \
     ...
     --sample_csv hprc_int_asm_batch3_polished.csv \
...
python3 /private/groups/hprc/hprc_intermediate_assembly/hpc/update_table_with_outputs.py \
    --input_data_table hprc_int_asm_batch3_polished.csv \
    --output_data_table batch3_genbank_upload_prep_outputs.csv  \
...
python3 /private/groups/hprc/hprc_intermediate_assembly/hpc/misc/extract_asm_cleanup_stats.py \
    --input_csv ../batch3_genbank_upload_prep_outputs.csv \
    --output_prefix hprc_int_asm_batch3
...
ascp \
    ...
    -l100m \
    -k1 \
    -d batch3_genbank_upload \
    subasp@upload.ncbi.nlm.nih.gov:uploads/juklucas_ucsc.edu_tD3gRQfz/int_asm_batch3
...
python3 /private/groups/hprc/hprc_intermediate_assembly/hpc/misc/link_to_subfolder.py \
     --csv_file ../batch3_genbank_upload_prep_outputs.csv \
...
ssds staging upload \
    ...
    upload \
    &>>batch3_s3_upload_pt1.upload.stderr
