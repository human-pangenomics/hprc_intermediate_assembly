...
cp /private/groups/hprc/polishing/batch7/hprc_polishing_QC_k31/HPRC_Assembly_s3Locs_batch6_w_hifiasm_w_QC.polished.csv ./

## filter out failures (or samples who need attention)
grep -vE '^HG02841|^HG02514|^HG04187' \
    HPRC_Assembly_s3Locs_batch6_w_hifiasm_w_QC.polished.csv  \
    > hprc_int_asm_batch6_polished.csv
...
python3 /private/groups/hprc/hprc_intermediate_assembly/hpc/launch_from_table.py \
     --data_table ../hprc_int_asm_batch6_polished.csv \
...
sbatch \
     ...
     --sample_csv hprc_int_asm_batch6_polished.csv \
     --input_json_path '../input_jsons/${SAMPLE_ID}_assembly_cleanup.json' 

## collect results into data table    
python3 /private/groups/hprc/hprc_intermediate_assembly/hpc/update_table_with_outputs.py \
    --input_data_table hprc_int_asm_batch6_polished.csv \
    --output_data_table batch6_genbank_upload_prep_outputs.csv  \
...
python3 /private/groups/hprc/hprc_intermediate_assembly/hpc/misc/extract_asm_cleanup_stats.py \
    --input_csv ../batch6_genbank_upload_prep_outputs.csv \
    --output_prefix hprc_int_asm_batch6
...
python3 /private/groups/hprc/hprc_intermediate_assembly/hpc/misc/link_to_folder.py \
    --data_table_csv batch6_genbank_upload_prep_outputs.csv \
    --columns_to_link hap1_output_fasta_gz hap2_output_fasta_gz \
    --target_dir batch6_genbank_upload
...
ascp \
    ...
    -l100m \
    -k1 \
    -d batch6_genbank_upload \
    subasp@upload.ncbi.nlm.nih.gov:uploads/juklucas_ucsc.edu_tD3gRQfz/int_asm_batch6
...
python3 /private/groups/hprc/hprc_intermediate_assembly/hpc/misc/link_to_subfolder.py \
     --csv_file ../batch6_genbank_upload_prep_outputs.csv \
...
ssds staging upload \
    ...
    upload \
    &>>batch6_s3_upload_pt1.upload.stderr
