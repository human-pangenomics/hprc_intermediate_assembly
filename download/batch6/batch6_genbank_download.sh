...
python3 /private/groups/hprc/hprc_intermediate_assembly/hpc/misc/lookup_genbank_accessions.py \
    genome-info-14707520.tsv \
    batch6_genbank_accession_ids.csv 


## remove HG03579 because it has multiple accessions for some reason
mv batch6_genbank_accession_ids.csv batch6_genbank_accession_ids.original.csv

grep -v "HG03579" batch6_genbank_accession_ids.original.csv > batch6_genbank_accession_ids.csv
...
python3 /private/groups/hprc/hprc_intermediate_assembly/hpc/launch_from_table.py \
     --data_table ../batch6_genbank_accession_ids.csv \
...
sbatch \
     ...
     --sample_csv batch6_genbank_accession_ids.csv \
...
python3 /private/groups/hprc/hprc_intermediate_assembly/hpc/update_table_with_outputs.py \
    --input_data_table batch6_genbank_accession_ids.csv \
    --output_data_table batch6_genbank_assembly.csv  \
...
python3 /private/groups/hprc/hprc_intermediate_assembly/hpc/misc/link_to_subfolder.py \
     --csv_file batch6_genbank_assembly.csv \
