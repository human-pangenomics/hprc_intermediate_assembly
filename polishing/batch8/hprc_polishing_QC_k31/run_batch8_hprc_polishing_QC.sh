...
cd /Users/miramastoras/Desktop/github_repos/hprc_intermediate_assembly/polishing/batch8/hprc_polishing_QC_k31/hprc_polishing_QC_input_jsons
...
cp -r /private/groups/hprc/polishing/hprc_intermediate_assembly/polishing/batch8/hprc_polishing_QC_k31/* ./
...
python3 /private/groups/hprc/polishing/hprc_intermediate_assembly/hpc/update_table_with_outputs.py \
      --input_data_table HPRC_Assembly_s3Locs_batch7_trioandhic_for_polishing.polished.csv \
      --output_data_table HPRC_Assembly_s3Locs_batch7_trioandhic_for_polishing.polished.K31QC.csv \
