...
cd /Users/miramastoras/Desktop/github_repos/hprc_intermediate_assembly/polishing/batch9/hprc_DeepPolisher_input_jsons
...
cp -r /private/groups/hprc/polishing/hprc_intermediate_assembly/polishing/batch9/* ./
