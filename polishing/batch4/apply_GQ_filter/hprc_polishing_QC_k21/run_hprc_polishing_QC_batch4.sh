...
mkdir -p /Users/miramastoras/Desktop/Paten_lab/hprc_intermediate_assembly/polishing/batch4/apply_GQ_filter/hprc_polishing_QC_k21/hprc_polishing_QC_input_jsons
...
## on HPC...
mkdir -p /private/groups/hprc/polishing/batch4/apply_GQ_filter/hprc_polishing_QC/
...
cp -r /private/groups/hprc/polishing/hprc_intermediate_assembly/polishing/batch4/apply_GQ_filter/hprc_polishing_QC_k21/* ./
...
sbatch \
     --job-name=hprc-polishing_QC_k21-batch4 \
     --array=[10]%1 \
