...
cd /Users/miramastoras/Desktop/github_repos/hprc_intermediate_assembly/polishing/batch10/hprc_DeepPolisher_input_jsons

python3 ../../../hpc/launch_from_table.py \
     --data_table ../HPRC_Assembly_s3Locs_batch9_trio_w_hifiasm_w_QC_hic.csv \
...
cp -r /private/groups/hprc/polishing/hprc_intermediate_assembly/polishing/batch10/* ./
...
sbatch \
     ...
     --sample_csv HPRC_Assembly_s3Locs_batch9_trio_w_hifiasm_w_QC_hic.csv \
