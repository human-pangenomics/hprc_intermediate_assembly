...
cd /Users/miramastoras/Desktop/Paten_lab/hprc_intermediate_assembly/polishing/batch6/hprc_polishing_QC_k31/hprc_polishing_QC_input_jsons

python3 ../../../../hpc/launch_from_table.py \
     --data_table ../HPRC_Assembly_s3Locs_Batch5_w_hifiasm.polished.csv \
...
cp -r /private/groups/hprc/polishing/hprc_intermediate_assembly/polishing/batch6/hprc_polishing_QC_k31/* ./
...
# submit job
sbatch \
     --job-name=hprc-polishing_QC_k31-batch6 \
     --array=[1-14]%14 \
...
python3 /private/groups/hprc/polishing/hprc_intermediate_assembly/hpc/update_table_with_outputs.py \
      ...
      --output_data_table HPRC_Assembly_s3Locs_Batch5_w_hifiasm.polished.QC.k31.csv  \
