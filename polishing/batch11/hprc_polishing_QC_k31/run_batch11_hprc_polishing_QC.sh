...
cd /Users/miramastoras/Desktop/github_repos/hprc_intermediate_assembly/polishing/batch11/hprc_polishing_QC_k31/hprc_polishing_QC_input_jsons

python3 ../../../../hpc/launch_from_table.py \
     --data_table ../HPRC_Assembly_s3Locs_batch10_trio_w_hifiasm_w_QC.polished.csv \
...
cp -r /private/groups/hprc/polishing/hprc_intermediate_assembly/polishing/batch11/hprc_polishing_QC_k31/* ./
...
# submit job
sbatch \
     --job-name=hprc-polishing_QC_k31-batch11 \
     --array=[1-17]%17 \
...
cd /private/groups/hprc/polishing/batch11/hprc_polishing_QC_k31
...
ls | grep "HG" | while read line ; do echo $line ; cat $line/analysis/hprc_polishing_QC_outputs/${line}.polishing.QC.csv  ; done >> all_samples_batch11_k31.csv
ls | grep "NA" | while read line ; do echo $line ; cat $line/analysis/hprc_polishing_QC_outputs/${line}.polishing.QC.csv  ; done >> all_samples_batch11_k31.csv
